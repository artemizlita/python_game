...
wave_step = []
wave_step.append(pygame.image.load('data\\global\\waves\\0.png').convert_alpha())
wave_step.append(pygame.image.load('data\\global\\waves\\1.png').convert_alpha())
wave_step.append(pygame.image.load('data\\global\\waves\\2.png').convert_alpha())
wave_step.append(pygame.image.load('data\\global\\waves\\3.png').convert_alpha())
wave_step.append(pygame.image.load('data\\global\\waves\\4.png').convert_alpha())
wave_step.append(pygame.image.load('data\\global\\waves\\5.png').convert_alpha())
wave_step.append(pygame.image.load('data\\global\\waves\\6.png').convert_alpha())
...
barkas_sail0 = []
for i in range(0, 12):
    image_sail_1 = pygame.image.load('data\\global\\barkas\\' + str(i) + '\\sail_1.png').convert_alpha()
    image_sail_0 = pygame.image.load('data\\global\\barkas\\' + str(i) + '\\sail_0.png').convert_alpha()
...
pink_sail0 = []
for i in range(0, 12):
    image_sail_1 = pygame.image.load('data\\global\\pink\\' + str(i) + '\\sail_1.png').convert_alpha()
    image_sail_0 = pygame.image.load('data\\global\\pink\\' + str(i) + '\\sail_0.png').convert_alpha()
...
ladya_sail0 = []
for i in range(0, 12):
    image_sail_1 = pygame.image.load('data\\global\\ladya\\' + str(i) + '\\sail_1.png').convert_alpha()
    image_sail_0 = pygame.image.load('data\\global\\ladya\\' + str(i) + '\\sail_0.png').convert_alpha()
...
shuna_sail0 = []
for i in range(0, 12):
    image_sail_1 = pygame.image.load('data\\global\\shuna\\' + str(i) + '\\sail_1.png').convert_alpha()
    image_sail_0 = pygame.image.load('data\\global\\shuna\\' + str(i) + '\\sail_0.png').convert_alpha()
...
lugger_sail0 = []
for i in range(0, 12):
    image_sail_1 = pygame.image.load('data\\global\\lugger\\' + str(i) + '\\sail_1.png').convert_alpha()
    image_sail_0 = pygame.image.load('data\\global\\lugger\\' + str(i) + '\\sail_0.png').convert_alpha()
...
shlup_sail0 = []
for i in range(0, 12):
    image_sail_1 = pygame.image.load('data\\global\\shlup\\' + str(i) + '\\sail_1.png').convert_alpha()
    image_sail_0 = pygame.image.load('data\\global\\shlup\\' + str(i) + '\\sail_0.png').convert_alpha()
...
bark_sail0 = []
for i in range(0, 12):
    image_sail_1 = pygame.image.load('data\\global\\bark\\' + str(i) + '\\sail_1.png').convert_alpha()
    image_sail_0 = pygame.image.load('data\\global\\bark\\' + str(i) + '\\sail_0.png').convert_alpha()
...
fleyt_sail0 = []
for i in range(0, 12):
    image_sail_1 = pygame.image.load('data\\global\\fleyt\\' + str(i) + '\\sail_1.png').convert_alpha()
    image_sail_0 = pygame.image.load('data\\global\\fleyt\\' + str(i) + '\\sail_0.png').convert_alpha()
...
brig_sail0 = []
for i in range(0, 12):
    image_sail_1 = pygame.image.load('data\\global\\brig\\' + str(i) + '\\sail_1.png').convert_alpha()
    image_sail_0 = pygame.image.load('data\\global\\brig\\' + str(i) + '\\sail_0.png').convert_alpha()
...
galera_sail0 = []
for i in range(0, 12):
    image_sail_1 = pygame.image.load('data\\global\\galera\\' + str(i) + '\\sail_1.png').convert_alpha()
    image_sail_0 = pygame.image.load('data\\global\\galera\\' + str(i) + '\\sail_0.png').convert_alpha()
...
pinas_sail0 = []
for i in range(0, 12):
    image_sail_1 = pygame.image.load('data\\global\\pinas\\' + str(i) + '\\sail_1.png').convert_alpha()
    image_sail_0 = pygame.image.load('data\\global\\pinas\\' + str(i) + '\\sail_0.png').convert_alpha()
...
corvet_sail0 = []
for i in range(0, 12):
    image_sail_1 = pygame.image.load('data\\global\\corvet\\' + str(i) + '\\sail_1.png').convert_alpha()
    image_sail_0 = pygame.image.load('data\\global\\corvet\\' + str(i) + '\\sail_0.png').convert_alpha()
...
fregat_sail0 = []
for i in range(0, 12):
    image_sail_1 = pygame.image.load('data\\global\\fregat\\' + str(i) + '\\sail_1.png').convert_alpha()
    image_sail_0 = pygame.image.load('data\\global\\fregat\\' + str(i) + '\\sail_0.png').convert_alpha()
...
galeon_sail0 = []
for i in range(0, 12):
    image_sail_1 = pygame.image.load('data\\global\\galeon\\' + str(i) + '\\sail_1.png').convert_alpha()
    image_sail_0 = pygame.image.load('data\\global\\galeon\\' + str(i) + '\\sail_0.png').convert_alpha()
...
warship_sail0 = []
for i in range(0, 12):
    image_sail_1 = pygame.image.load('data\\global\\warship\\' + str(i) + '\\sail_1.png').convert_alpha()
    image_sail_0 = pygame.image.load('data\\global\\warship\\' + str(i) + '\\sail_0.png').convert_alpha()
...
fraction_relations = {'PLAYER': 0, 'RED': 0, 'GREEN': 0, 'BLUE': 0, 'PIRATE': -100}
...
def angle_to_radian(angle):
    if angle == 0:
        ...
        return math.atan(5 / 3)
    elif angle == 2:
        return math.atan(9 / 3)
    elif angle == 3:
        return 0.5 * math.pi
    elif angle == 4:
        return math.pi - math.atan(9 / 3)
    elif angle == 5:
        return math.pi - math.atan(5 / 3)
    elif angle == 6:
        return math.pi
    elif angle == 7:
        return math.pi + math.atan(5 / 3)
        ...
        return 2 * math.pi - math.atan(9 / 3)
    elif angle == 11:
        return 2 * math.pi - math.atan(5 / 3)
...
def war_fleet_generate(fraction):
    ...
    while cross_player:
        ...
        if side == 1:
            ...
            y = towns[f][1] + randint(0.5 * i_height, i_height * 1.5)
        if island_intersection(x + island_x, y + island_y, x + island_x, y + island_y,
                               -i_width + 10, -i_height + 10, i_width - 10, i_height - 10) and fraction != 'PLAYER':
            cross_player = True
    if towns[f][2] == 1:
        fleets.append(fleet_object([["lugger", 25]], 1.6, island_x + x, island_y + y, x, y,
...
def mercenaries_generate(fraction):
    ...
    while cross_player:
        ...
        if side == 1:
            ...
            y = pirate_bases[f][1] + randint(0.5 * i_height, i_height * 1.5)
        if island_intersection(x + island_x, y + island_y, x + island_x, y + island_y,
                               -i_width + 10, -i_height + 10, i_width - 10, i_height - 10):
            cross_player = True
...
def run_game():
    ...
    global island_x, island_y, map_width, map_height
    forpost_zone = False

    menu = -1
    stop = 0
    start_menu = True
    map_properties = [20, 30, 50, 50, 1]
    start_fleet = 0
    start_fleet_type = ['traveller', 'trader', 'raider']
    while start_menu:
        ...
        if keys[pygame.K_a]:
            if menu == -1:
                ...
                if menu == 0:
                    if map_properties[menu] > 20:
                        map_properties[menu] -= 4
                elif menu == 4:
                    if map_properties[menu] > 1:
                        map_properties[menu] -= 1
                else:
                    if map_properties[menu] > 10:
                        map_properties[menu] -= 10
            stop = 5
            ...
            if menu == -1:
                ...
                if menu == 0:
                    if map_properties[menu] < 40:
                        map_properties[menu] += 4
                elif menu == 4:
                    if map_properties[menu] < 3:
                        map_properties[menu] += 1
                else:
                    if map_properties[menu] < 100:
                        map_properties[menu] += 10
            stop = 5
        ...
        if keys[pygame.K_ESCAPE]:
            sys.exit()
        if map_properties[4] > 1:
            start_fleet_type[0] = 'warrior'
        else:
            start_fleet_type[0] = 'traveller'
        if stop > 0:
            stop -= 1
        f = pygame.font.Font(None, 40)
        text = f.render('FLEET TYPE: ' + start_fleet_type[start_fleet], True, (255, 0, 255))
        text_rect = text.get_rect(center=(display_width // 2, display_height // 2 - 100))
        display.blit(text, text_rect)
        f = pygame.font.Font(None, 40)
        text = f.render('MAP SIZE: ' + str(map_properties[0]) + ' hexes', True, (255, 0, 0))
        text_rect = text.get_rect(center=(display_width // 2, display_height // 2 - 60))
        display.blit(text, text_rect)
        f = pygame.font.Font(None, 40)
        text = f.render('GRASS ISLANDS: ' + str(map_properties[1]) + ' %', True, (255, 0, 0))
        text_rect = text.get_rect(center=(display_width // 2, display_height // 2 - 20))
        display.blit(text, text_rect)
        f = pygame.font.Font(None, 40)
        text = f.render('FORPOSTS: ' + str(map_properties[2]) + ' %', True, (255, 0, 0))
        text_rect = text.get_rect(center=(display_width // 2, display_height // 2 + 20))
        display.blit(text, text_rect)
        f = pygame.font.Font(None, 40)
        text = f.render('PIRATE BASES: ' + str(map_properties[3]) + ' %', True, (255, 0, 0))
        text_rect = text.get_rect(center=(display_width // 2, display_height // 2 + 60))
        display.blit(text, text_rect)
        f = pygame.font.Font(None, 40)
        text = f.render('GAME TIME: ' + str(map_properties[4]) + ' stage', True, (0, 255, 0))
        text_rect = text.get_rect(center=(display_width // 2, display_height // 2 + 100))
        display.blit(text, text_rect)
        f = pygame.font.Font(None, 40)
        text = f.render('<<', True, (255, 255, 0))
        text_rect = text.get_rect(center=(display_width // 2 - 200, display_height // 2 - 60 + menu * 40))
        display.blit(text, text_rect)
        f = pygame.font.Font(None, 40)
        text = f.render('>>', True, (255, 255, 0))
        text_rect = text.get_rect(center=(display_width // 2 + 200, display_height // 2 - 60 + menu * 40))
        display.blit(text, text_rect)
        f = pygame.font.Font(None, 40)
        text = f.render('press (Z) to start game', True, (0, 0, 255))
        text_rect = text.get_rect(center=(display_width // 2, display_height // 2 + 140))
        display.blit(text, text_rect)
        pygame.display.update()
        menu_timer.tick(10)

    display.fill((0, 0, 0))
    map_width = map_properties[0]
    map_height = map_properties[0]
    menu = 0
    stop = 0
    ...
    k = 0
    land = 'sand'
    while k < 500 or (land == 'grass' and map_properties[1] < 100):
        need_island = True
        k = 0
        forp = randint(0, 99)
        f = randint(0, 2)
        if forp < map_properties[2]:
            forpost = 1
            if f == 0:
                fraction = 'RED'
            elif f == 1:
        ...
        if not(need_island):
            f = pygame.font.Font(None, 36)
            coord = f.render('generate (' + fraction + ') fraction island; (' + land + ') biom', True, color)
            if (text + 36) >= display_height:
                text = 0
                two_column = display_width // 2
            display.blit(coord, (10 + two_column, 10 + text))
            text += 36
            pygame.display.update()
    ...
    if start_fleet_type[start_fleet] == 'traveller':
        fleets.append(fleet_object([['pink', 15], ['pink', 15]], 1.2, 0, 0, 0, 0, 0, 0, 'PLAYER',
                         randint(ship_stats['pink'].cost // 2, ship_stats['pink'].cost), 0))
    elif start_fleet_type[start_fleet] == 'warrior':
        player_fraction = True
        if map_properties[4] == 2:
            ship = "lugger"
        elif map_properties[4] == 3:
            ship = "brig"
        # elif map_properties[4] == 4:
        #     ship = "corvet"
        fleets.append(fleet_object([[ship, ship_stats[ship].max_hp], [ship, ship_stats[ship].max_hp], [ship, ship_stats[ship].max_hp]],
                                   ship_stats[ship].speed, 0, 0, 0, 0, 0, 0, 'PLAYER',
                                   randint(ship_stats[ship].cost * 3 // 4, ship_stats[ship].cost * 3 // 2), 0))
        if map_properties[4] == 3:
            fleets[0].ships.append(["brig", 40])
            fleets[0].gold += randint(ship_stats["brig"].cost // 4, ship_stats["brig"].cost // 2)
    elif start_fleet_type[start_fleet] == 'trader':
        if map_properties[4] == 1:
            ship = "ladya"
        elif map_properties[4] == 2:
            ship = "fleyt"
        elif map_properties[4] == 3:
            ship = "pinas"
        # elif map_properties[4] == 4:
        #     ship = "galeon"
        fleets.append(fleet_object([[ship, ship_stats[ship].max_hp]], ship_stats[ship].speed, 0, 0, 0, 0, 0, 0, 'PLAYER',
                                   randint(ship_stats[ship].cost // 2, ship_stats[ship].cost), 0))
        fraction_relations['RED'] = 2 * map_properties[4] ** 2 + 3
        fraction_relations['GREEN'] = 2 * map_properties[4] ** 2 + 3
        fraction_relations['BLUE'] = 2 * map_properties[4] ** 2 + 3
    elif start_fleet_type[start_fleet] == 'raider':
        if map_properties[4] == 1:
            ship = "shuna"
        elif map_properties[4] == 2:
            ship = "bark"
        ...
        #     ship = "warship"
        fleets.append(fleet_object([[ship, ship_stats[ship].max_hp]], ship_stats[ship].speed, 0, 0, 0, 0, 0, 0, 'PLAYER',
                                   randint(ship_stats[ship].cost // 4, ship_stats[ship].cost // 2), 0))
        if map_properties[4] > 1:
            fleets[0].ships.append([ship, ship_stats[ship].max_hp])
        fraction_relations['RED'] = - 2 * map_properties[4] ** 2 - 3
        fraction_relations['GREEN'] = - 2 * map_properties[4] ** 2 - 3
        fraction_relations['BLUE'] = - 2 * map_properties[4] ** 2 - 3
    fleets[0].move = False

    if map_properties[4] == 4:
        game_time = 4200 * 6
        for forpost in forposts:
    ...
    for forpost in forposts:
        ...
        pirates_generate(max(map_properties[4] - 2, 0))
    for forpost in forposts:
        if forpost[5] == 'PIRATE':
            fwfc = copy.copy(fraction_war_fleet_count)
            fwfc.pop('PLAYER')
...
#####################################################map_sprites########################################################
    ...
    sand_1ne = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1ne.png').convert_alpha(),
                                            ((i_width + 16) / scale, (i_height + 184) / scale))
    sand_1nse = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1nse.png').convert_alpha(),
                                             ((i_width + 16) / scale, (i_height + 184) / scale))
    sand_1nsw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1nsw.png').convert_alpha(),
                                             ((i_width + 16) / scale, (i_height + 184) / scale))
    sand_1nswe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1nswe.png').convert_alpha(),
                                              ((i_width + 16) / scale, (i_height + 184) / scale))
    sand_1nw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1nw.png').convert_alpha(),
                                            ((i_width + 16) / scale, (i_height + 184) / scale))
    sand_1nwe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1nwe.png').convert_alpha(),
                                             ((i_width + 16) / scale, (i_height + 184) / scale))
    sand_1se = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1se.png').convert_alpha(),
                                            ((i_width + 16) / scale, (i_height + 184) / scale))
    sand_1sw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1sw.png').convert_alpha(),
                                            ((i_width + 16) / scale, (i_height + 184) / scale))
    sand_1swe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1swe.png').convert_alpha(),
                                             ((i_width + 16) / scale, (i_height + 184) / scale))

    grass_1ne = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1ne.png').convert_alpha(),
                                             ((i_width + 16) / scale, (i_height + 184) / scale))
    grass_1nse = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1nse.png').convert_alpha(),
                                              ((i_width + 16) / scale, (i_height + 184) / scale))
    grass_1nsw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1nsw.png').convert_alpha(),
                                              ((i_width + 16) / scale, (i_height + 184) / scale))
    grass_1nswe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1nswe.png').convert_alpha(),
                                               ((i_width + 16) / scale, (i_height + 184) / scale))
    grass_1nw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1nw.png').convert_alpha(),
                                             ((i_width + 16) / scale, (i_height + 184) / scale))
    grass_1nwe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1nwe.png').convert_alpha(),
                                              ((i_width + 16) / scale, (i_height + 184) / scale))
    grass_1se = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1se.png').convert_alpha(),
                                             ((i_width + 16) / scale, (i_height + 184) / scale))
    grass_1sw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1sw.png').convert_alpha(),
                                             ((i_width + 16) / scale, (i_height + 184) / scale))
    grass_1swe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1swe.png').convert_alpha(),
                                              ((i_width + 16) / scale, (i_height + 184) / scale))

    snow_1ne = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1ne.png').convert_alpha(),
                                             ((i_width + 16) / scale, (i_height + 184) / scale))
    snow_1nse = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1nse.png').convert_alpha(),
                                              ((i_width + 16) / scale, (i_height + 184) / scale))
    snow_1nsw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1nsw.png').convert_alpha(),
                                              ((i_width + 16) / scale, (i_height + 184) / scale))
    snow_1nswe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1nswe.png').convert_alpha(),
                                               ((i_width + 16) / scale, (i_height + 184) / scale))
    snow_1nw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1nw.png').convert_alpha(),
                                             ((i_width + 16) / scale, (i_height + 184) / scale))
    snow_1nwe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1nwe.png').convert_alpha(),
                                              ((i_width + 16) / scale, (i_height + 184) / scale))
    snow_1se = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1se.png').convert_alpha(),
                                             ((i_width + 16) / scale, (i_height + 184) / scale))
    snow_1sw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1sw.png').convert_alpha(),
                                             ((i_width + 16) / scale, (i_height + 184) / scale))
    snow_1swe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1swe.png').convert_alpha(),
                                              ((i_width + 16) / scale, (i_height + 184) / scale))

    image_forpost1 = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\forpost1.png').convert_alpha(),
                                                  ((i_width + 16) / scale, (i_height + 184) / scale))
    image_forpost2 = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\forpost2.png').convert_alpha(),
                                                  ((i_width + 16) / scale, (i_height + 184) / scale))
    image_forpost3 = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\forpost3.png').convert_alpha(),
                                                  ((i_width + 16) / scale, (i_height + 204) / scale))
    image_forpost4 = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\forpost4.png').convert_alpha(),
                                                  ((i_width + 16) / scale, (i_height + 264) / scale))
    image_forpost_zone = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\forpost_zone.png').convert_alpha(),
                                                      ((i_width + 16) / scale, (i_height + 184) / scale))

    image_palm = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\palm.png').convert_alpha(),
                                              (128 / scale, 256 / scale))
    image_tree = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\tree.png').convert_alpha(),
                                              (144 / scale, 376 / scale))
    image_ship_tree = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\ship_tree.png').convert_alpha(),
                                              (96 / scale, 576 / scale))

##################################################minimap_sprites#######################################################

    m_sand_1ne = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1ne.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_sand_1nse = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1nse.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_sand_1nsw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1nsw.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_sand_1nswe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1nswe.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_sand_1nw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1nw.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_sand_1nwe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1nwe.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_sand_1se = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1se.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_sand_1sw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1sw.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_sand_1swe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\sand\\1swe.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))

    m_grass_1ne = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1ne.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_grass_1nse = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1nse.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_grass_1nsw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1nsw.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_grass_1nswe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1nswe.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_grass_1nw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1nw.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_grass_1nwe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1nwe.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_grass_1se = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1se.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_grass_1sw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1sw.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_grass_1swe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\grass\\1swe.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))

    m_snow_1ne = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1ne.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_snow_1nse = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1nse.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_snow_1nsw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1nsw.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_snow_1nswe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1nswe.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_snow_1nw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1nw.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_snow_1nwe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1nwe.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_snow_1se = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1se.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_snow_1sw = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1sw.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_snow_1swe = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\snow\\1swe.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))

    m_image_forpost1 = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\forpost1.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_image_forpost2 = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\forpost2.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 184) / 17))
    m_image_forpost3 = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\forpost3.png').convert_alpha(),
                                              ((i_width + 16) / 17, (i_height + 204) / 17))
    m_image_forpost4 = pygame.transform.smoothscale(pygame.image.load('data\\global\\island_sprite\\forpost4.png').convert_alpha(),
                ...
                if fleet == fleets[0]:
                    ...
                    if islands_check(fleet.x - island_x, fleet.y - island_y, fleet.x - island_x, fleet.y - island_y, deck_size / 2.5):
                        if fleet.angle == 6:
                            ...
                            island_y += -0.398 * fleet.speed * speed_mode
                        elif fleet.angle == 7:
                            island_x += 0.55 * fleet.speed * speed_mode
                            island_y += -0.33 * fleet.speed * speed_mode
                        elif fleet.angle == 8:
                            island_x += 0.765 * fleet.speed * speed_mode
                            island_y += -0.255 * fleet.speed * speed_mode
                        elif fleet.angle == 9:
                            island_x += 0.995 * fleet.speed * speed_mode
            ...
            if fleet != fleets[0]:
                if fleet.type == 1:
                    ...
                    if gip < 32:
                            ...
                            for ship in fleet.ships:
                                if ship[0] in ['ladya', 'fleyt', 'pinas', 'galeon']:
                                    ...
                                    if max_trade_ships <= 2:
                                        profit += randint(ship_stats[ship[0]].cost // 100, ship_stats[ship[0]].cost // 50) * (
                        ...
                        if fleet.gold >= ship_stats[trade_ship].cost and len(fleet.ships) < 5:
                    ...
                    for other_fleet in fleets:
                        if (other_fleet.type == 0 and fraction_relations['PIRATE'] == 0) or (other_fleet.type == 1) or (other_fleet.type == 4):
                        ...
                        if mingip < 32 and fleet.gold > 0:
                            ...
                            for ship in fleet.ships:
                                ...
                                if fleet.gold < 0:
                                    ship[1] -= 1
                                    fleet.gold += repair_cost
                            fleet.gold -= randint(ship_stats[ship[0]].cost // 100, ship_stats[ship[0]].cost // 50)
                            if fleet.gold < 0:
                                fleet.gold = 0
                    ...
                    mingip = (fleet.rank + 3) * i_width / 2
                    for other_fleet in fleets:
                        if (other_fleet.type == 0 and fraction_relations['PIRATE'] == 0 and fraction_relations[fleet.fraction] < 0) or (
                           other_fleet.type in [0, 1, 3, 4, 5] and fraction_wars[fleet.fraction][other_fleet.fraction] == True):
                            gip = ((fleet.x - other_fleet.x) ** 2 + 6.25 * (fleet.y - other_fleet.y) ** 2) ** 0.5
                            if gip < mingip:
                                fleet.target_x = -island_x + other_fleet.x
        ...
        if keys[pygame.K_m]:
            ...
            for forpost in forposts:
                ...
                if forpost[5] == 'RED':
                    ...
                    color = (64, 64, 64)
                if forpost[2] == 1:
                    rect = m_image_forpost1.get_rect(center=(
                    center_x + (fx - i_width / 2) / 16, center_y * 2 / 3 + (fy - i_height / 2) / 16))
                    ...
                    rect = m_image_forpost2.get_rect(center=(
                    center_x + (fx - i_width / 2) / 16, center_y * 2 / 3 + (fy - i_height / 2) / 16))
                    ...
                    rect = m_image_forpost3.get_rect(center=(
                    center_x + (fx - i_width / 2) / 16, center_y * 2 / 3 + (fy - i_height / 2) / 16))
                    ...
                    rect = m_image_forpost4.get_rect(center=(
                    center_x + (fx - i_width / 2) / 16, center_y * 2 / 3 + (fy - i_height / 2) / 16))
            ...
            for fleet in fleets_paint:
                if (-display_width - ship_stats[fleet.ships[0][0]].pic_size / 8 < fleet.x < display_width +
                    ship_stats[fleet.ships[0][0]].pic_size / 8) and (
                        -display_height - ship_stats[
                    fleet.ships[0][0]].pic_size / 8 < fleet.y < display_height + ship_stats[
                            fleet.ships[0][0]].pic_size / 8):
                    if fleet.move == True:
                        image = pygame.transform.smoothscale(
                            ship_stats[fleet.ships[0][0]].ms_sail1[fleet.angle],
                            (ship_stats[fleet.ships[0][0]].pic_size / 16,
                             ship_stats[fleet.ships[0][0]].pic_size / 16))
                    else:
                        image = pygame.transform.smoothscale(
                            ship_stats[fleet.ships[0][0]].ms_sail0[fleet.angle],
                            (ship_stats[fleet.ships[0][0]].pic_size / 16,
                             ship_stats[fleet.ships[0][0]].pic_size / 16))
                    rect = image.get_rect(center=(
                    center_x + (fleet.x - island_x) / 16, center_y * 2 / 3 + (fleet.y - island_y) / 16))
            ...
            for ship in fleets[0].ships:
                ...
                b1 = name.render('health:  ' + str(int(ship[1])) + ' / ' + str(int(ship_stats[ship[0]].max_hp)),
                                 True, (255, 0, 0))
                display.blit(b1, (center_x + step - 50, center_y * 5 / 3 + 62))
                name = pygame.font.Font(None, 24)
                b1 = name.render('speed: ' + str(int(ship_stats[ship[0]].speed * 5)) + ' knots', True,
                                 (0, 0, 255))
...
##########################################################info##########################################################
            ...
            for fleet in fleets:
                if (-display_width - ship_stats[fleet.ships[0][0]].pic_size < fleet.x < display_width + ship_stats[fleet.ships[0][0]].pic_size) and (
                    ...
                    if fleet.fraction == 'PLAYER':
                        if fraction_relations['PIRATE'] == 0:
                            color = (255, 0, 255)
                        else:
                            color = (192, 192, 192)
                    ...
                    if fleet.type == 0:
                        f = pygame.font.Font(None, 48 // scale)
                        info = f.render('PLAYER', True, color)
            ...
            if not(forpost_zone):
                ...
                coord = f.render("(1)/(2)/(3)/(4)/(5) - swap ships in fleet; +-20/35/65/95 points to capture.", True, (0, 0, 0))
                ...
                coord = f.render("Buy/sold/repair ships in forpost zones. To take relation points - kill", True, (0, 0, 0))
                display.blit(coord, (10, display_height - 90))
                coord = f.render("pirates, trading with forposts or kill fraction enemies. You can capture", True, (0, 0, 0))
                display.blit(coord, (10, display_height - 70))
                coord = f.render("forpost friendly/enemy fractions and create PLAYER fraction. After capture", True, (0, 0, 0))
                    ...
                    if not(forpost_zone):
                        ...
                        if keys[pygame.K_z]:
                            if (fleets[0].gold >= fraction_relations[forpost[5]] * (-1000)) and not(player_fraction):
                                ...
                                fleets[0].move = 0
                                forpost_zone = True
                        if not(player_fraction) and math.fabs(fraction_relations[forpost[5]]) >= 5 * (forpost[2]) ** 2 + 15 or player_fraction and (
                                ...
                                if ship[0] in ['ladya', 'fleyt', 'pinas', 'galeon']:
                                    ...
                                    if max_trade_ships <= 2:
                                        ...
                                        if not(player_fraction):
                                            fraction_relations[forpost[5]] += 1
                                else:
                                    max_gold += ship_stats[ship[0]].cost
...
########################################################battle##########################################################
                    ...
                    if (other_fleet.type in [0, 1, 3, 4, 5]) and (fleet.fraction != other_fleet.fraction):
                        ...
                        if len(fleet.ships) > 0 and len(other_fleet.ships) > 0:
                            ...
                            if (gip < battle_radius):
                                ...
                                if keys[pygame.K_f]:
                                    if not(player_fraction):
                                        if fraction_relations[other_fleet.fraction] > 0:
                                            fraction_relations[other_fleet.fraction] = 0
                                ...
                                if other_fleet == fleets[0]:
                                    if not (player_fraction):
                                        ...
                                        for forpost in forposts:
                                            gip = ((forpost[0] - i_width / 2 + island_x - fleet.x) ** 2 + 6.25 * (
                                                    forpost[1] + i_height / 2 + island_y - fleet.y) ** 2) ** 0.5
                                            if gip < mingip and forpost[5] != 'PIRATE':
                                                mingip = gip
                                                near_fraction = forpost[5]
                                        if near_fraction != '-':
                                            fraction_relations[near_fraction] += 1
        ...
        f = pygame.font.Font(None, 36)
        forp = f.render(str(round(sum * 10, 3)), True, (255, 0, 0))
        display.blit(forp, (display_width - 80, 50))

        pygame.display.update()

        if fraction_relations['RED'] < 0 and fraction_relations['GREEN'] < 0 and fraction_relations['BLUE'] < 0:
            fraction_relations['PIRATE'] = 100
        else:
            fraction_relations['PIRATE'] = 0
        ...
        forposts_count = {'RED': 0, 'GREEN': 0, 'BLUE': 0, 'PLAYER': 0, 'PIRATE': 0}
        for forpost in forposts:
            forposts_count[forpost[5]] += 1
        ...
        for one_side in war_generate:
            ...
            if forposts_count[one_side] == 0 and one_side != 'PLAYER':
                there_war = False
                for two_side in war_generate:
                    if fraction_wars[one_side][two_side] and forposts_count[two_side] > 0:
                        there_war = True
                if not(there_war):
                    two_side = war_generate[randint(0, len(war_generate) - 1)]
                    if one_side != two_side and forposts_count[two_side] > 0:
                        fraction_wars[one_side][two_side] = True
                        fraction_wars[two_side][one_side] = True
